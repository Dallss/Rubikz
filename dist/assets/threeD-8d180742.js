...
`)+`
`+f);const M=E+m+r,A=E+f+a,V=oh(s,s.VERTEX_SHADER,M),b=oh(s,s.FRAGMENT_SHADER,A);s.attachShader(x,V),s.attachShader(x,b),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function R(X){if(i.debug.checkShaderErrors){const ee=s.getProgramInfoLog(x).trim(),I=s.getShaderInfoLog(V).trim(),J=s.getShaderInfoLog(b).trim();let ie=!0,re=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(ie=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,V,b);else{const me=rh(s,V,"vertex"),j=rh(s,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
Program Info Log: `+ee+`
`+me+`
`+j)}else ee!==""?console.warn("THREE.WebGLProgram: Program Info Log:",ee):(I===""||J==="")&&(re=!1);re&&(X.diagnostics={runnable:ie,programLog:ee,vertexShader:{log:I,prefix:m},fragmentShader:{log:J,prefix:f}})}s.deleteShader(V),s.deleteShader(b),B=new Br(s,x),T=My(s,x)}let B;this.getUniforms=function(){return B===void 0&&R(this),B};let T;this.getAttributes=function(){return T===void 0&&R(this),T};let v=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return v===!1&&(v=s.getProgramParameter(x,fy)),v},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(x),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=py++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=V,this.fragmentShader=b,this}let Iy=0;class Dy{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,s=this._getShaderStage(t),o=this._getShaderStage(n),r=this._getShaderCacheForMaterial(e);return r.has(s)===!1&&(r.add(s),s.usedTimes++),r.has(o)===!1&&(r.add(o),o.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new Uy(e),t.set(e,n)),n}}class Uy{constructor(e){this.id=Iy++,this.code=e,this.usedTimes=0}}function Oy(i,e,t,n,s,o,r){const a=new Md,c=new Dy,l=new Set,u=[],h=s.logarithmicDepthBuffer,d=s.vertexTextures;let p=s.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(T){return l.add(T),T===0?"uv":`uv${T}`}function m(T,v,X,ee,I){const J=ee.fog,ie=I.geometry,re=T.isMeshStandardMaterial?ee.environment:null,me=(T.isMeshStandardMaterial?t:e).get(T.envMap||re),j=me&&me.mapping===ua?me.image.height:null,le=g[T.type];T.precision!==null&&(p=s.getMaxPrecision(T.precision),p!==T.precision&&console.warn("THREE.WebGLProgram.getParameters:",T.precision,"not supported, using",p,"instead."));const ce=ie.morphAttributes.position||ie.morphAttributes.normal||ie.morphAttributes.color,be=ce!==void 0?ce.length:0;let et=0;ie.morphAttributes.position!==void 0&&(et=1),ie.morphAttributes.normal!==void 0&&(et=2),ie.morphAttributes.color!==void 0&&(et=3);let dt,K,ue,Se;if(le){const rt=di[le];dt=rt.vertexShader,K=rt.fragmentShader}else dt=T.vertexShader,K=T.fragmentShader,c.update(T),ue=c.getVertexShaderID(T),Se=c.getFragmentShaderID(T);const ge=i.getRenderTarget(),tt=I.isInstancedMesh===!0,$e=I.isBatchedMesh===!0,z=!!T.map,_t=!!T.matcap,Pe=!!me,xt=!!T.aoMap,De=!!T.lightMap,nt=!!T.bumpMap,Ge=!!T.normalMap,it=!!T.displacementMap,Rt=!!T.emissiveMap,w=!!T.metalnessMap,y=!!T.roughnessMap,Y=T.anisotropy>0,ne=T.clearcoat>0,oe=T.dispersion>0,ae=T.iridescence>0,Le=T.sheen>0,ve=T.transmission>0,xe=Y&&!!T.anisotropyMap,Ve=ne&&!!T.clearcoatMap,de=ne&&!!T.clearcoatNormalMap,Ce=ne&&!!T.clearcoatRoughnessMap,st=ae&&!!T.iridescenceMap,Ie=ae&&!!T.iridescenceThicknessMap,Me=Le&&!!T.sheenColorMap,ke=Le&&!!T.sheenRoughnessMap,Ze=!!T.specularMap,vt=!!T.specularColorMap,qe=!!T.specularIntensityMap,_=ve&&!!T.transmissionMap,O=ve&&!!T.thicknessMap,H=!!T.gradientMap,se=!!T.alphaMap,he=T.alphaTest>0,We=!!T.alphaHash,Ke=!!T.extensions;let It=kn;T.toneMapped&&(ge===null||ge.isXRRenderTarget===!0)&&(It=i.toneMapping);const Kt={shaderID:le,shaderType:T.type,shaderName:T.name,vertexShader:dt,fragmentShader:K,defines:T.defines,customVertexShaderID:ue,customFragmentShaderID:Se,isRawShaderMaterial:T.isRawShaderMaterial===!0,glslVersion:T.glslVersion,precision:p,batching:$e,instancing:tt,instancingColor:tt&&I.instanceColor!==null,instancingMorph:tt&&I.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:ge===null?i.outputColorSpace:ge.isXRRenderTarget===!0?ge.texture.colorSpace:ci,alphaToCoverage:!!T.alphaToCoverage,map:z,matcap:_t,envMap:Pe,envMapMode:Pe&&me.mapping,envMapCubeUVHeight:j,aoMap:xt,lightMap:De,bumpMap:nt,normalMap:Ge,displacementMap:d&&it,emissiveMap:Rt,normalMapObjectSpace:Ge&&T.normalMapType===pd,normalMapTangentSpace:Ge&&T.normalMapType===As,metalnessMap:w,roughnessMap:y,anisotropy:Y,anisotropyMap:xe,clearcoat:ne,clearcoatMap:Ve,clearcoatNormalMap:de,clearcoatRoughnessMap:Ce,dispersion:oe,iridescence:ae,iridescenceMap:st,iridescenceThicknessMap:Ie,sheen:Le,sheenColorMap:Me,sheenRoughnessMap:ke,specularMap:Ze,specularColorMap:vt,specularIntensityMap:qe,transmission:ve,transmissionMap:_,thicknessMap:O,gradientMap:H,opaque:T.transparent===!1&&T.blending===so&&T.alphaToCoverage===!1,alphaMap:se,alphaTest:he,alphaHash:We,combine:T.combine,mapUv:z&&x(T.map.channel),aoMapUv:xt&&x(T.aoMap.channel),lightMapUv:De&&x(T.lightMap.channel),bumpMapUv:nt&&x(T.bumpMap.channel),normalMapUv:Ge&&x(T.normalMap.channel),displacementMapUv:it&&x(T.displacementMap.channel),emissiveMapUv:Rt&&x(T.emissiveMap.channel),metalnessMapUv:w&&x(T.metalnessMap.channel),roughnessMapUv:y&&x(T.roughnessMap.channel),anisotropyMapUv:xe&&x(T.anisotropyMap.channel),clearcoatMapUv:Ve&&x(T.clearcoatMap.channel),clearcoatNormalMapUv:de&&x(T.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Ce&&x(T.clearcoatRoughnessMap.channel),iridescenceMapUv:st&&x(T.iridescenceMap.channel),iridescenceThicknessMapUv:Ie&&x(T.iridescenceThicknessMap.channel),sheenColorMapUv:Me&&x(T.sheenColorMap.channel),sheenRoughnessMapUv:ke&&x(T.sheenRoughnessMap.channel),specularMapUv:Ze&&x(T.specularMap.channel),specularColorMapUv:vt&&x(T.specularColorMap.channel),specularIntensityMapUv:qe&&x(T.specularIntensityMap.channel),transmissionMapUv:_&&x(T.transmissionMap.channel),thicknessMapUv:O&&x(T.thicknessMap.channel),alphaMapUv:se&&x(T.alphaMap.channel),vertexTangents:!!ie.attributes.tangent&&(Ge||Y),vertexColors:T.vertexColors,vertexAlphas:T.vertexColors===!0&&!!ie.attributes.color&&ie.attributes.color.itemSize===4,pointsUvs:I.isPoints===!0&&!!ie.attributes.uv&&(z||se),fog:!!J,useFog:T.fog===!0,fogExp2:!!J&&J.isFogExp2,flatShading:T.flatShading===!0,sizeAttenuation:T.sizeAttenuation===!0,logarithmicDepthBuffer:h,skinning:I.isSkinnedMesh===!0,morphTargets:ie.morphAttributes.position!==void 0,morphNormals:ie.morphAttributes.normal!==void 0,morphColors:ie.morphAttributes.color!==void 0,morphTargetsCount:be,morphTextureStride:et,numDirLights:v.directional.length,numPointLights:v.point.length,numSpotLights:v.spot.length,numSpotLightMaps:v.spotLightMap.length,numRectAreaLights:v.rectArea.length,numHemiLights:v.hemi.length,numDirLightShadows:v.directionalShadowMap.length,numPointLightShadows:v.pointShadowMap.length,numSpotLightShadows:v.spotShadowMap.length,numSpotLightShadowsWithMaps:v.numSpotLightShadowsWithMaps,numLightProbes:v.numLightProbes,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:T.dithering,shadowMapEnabled:i.shadowMap.enabled&&X.length>0,shadowMapType:i.shadowMap.type,toneMapping:It,useLegacyLights:i._useLegacyLights,decodeVideoTexture:z&&T.map.isVideoTexture===!0&&yt.getTransfer(T.map.colorSpace)===bt,premultipliedAlpha:T.premultipliedAlpha,doubleSided:T.side===Li,flipSided:T.side===_n,useDepthPacking:T.depthPacking>=0,depthPacking:T.depthPacking||0,index0AttributeName:T.index0AttributeName,extensionClipCullDistance:Ke&&T.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:Ke&&T.extensions.multiDraw===!0&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:T.customProgramCacheKey()};return Kt.vertexUv1s=l.has(1),Kt.vertexUv2s=l.has(2),Kt.vertexUv3s=l.has(3),l.clear(),Kt}function f(T){const v=[];if(T.shaderID?v.push(T.shaderID):(v.push(T.customVertexShaderID),v.push(T.customFragmentShaderID)),T.defines!==void 0)for(const X in T.defines)v.push(X),v.push(T.defines[X]);return T.isRawShaderMaterial===!1&&(E(v,T),M(v,T),v.push(i.outputColorSpace)),v.push(T.customProgramCacheKey),v.join()}function E(T,v){T.push(v.precision),T.push(v.outputColorSpace),T.push(v.envMapMode),T.push(v.envMapCubeUVHeight),T.push(v.mapUv),T.push(v.alphaMapUv),T.push(v.lightMapUv),T.push(v.aoMapUv),T.push(v.bumpMapUv),T.push(v.normalMapUv),T.push(v.displacementMapUv),T.push(v.emissiveMapUv),T.push(v.metalnessMapUv),T.push(v.roughnessMapUv),T.push(v.anisotropyMapUv),T.push(v.clearcoatMapUv),T.push(v.clearcoatNormalMapUv),T.push(v.clearcoatRoughnessMapUv),T.push(v.iridescenceMapUv),T.push(v.iridescenceThicknessMapUv),T.push(v.sheenColorMapUv),T.push(v.sheenRoughnessMapUv),T.push(v.specularMapUv),T.push(v.specularColorMapUv),T.push(v.specularIntensityMapUv),T.push(v.transmissionMapUv),T.push(v.thicknessMapUv),T.push(v.combine),T.push(v.fogExp2),T.push(v.sizeAttenuation),T.push(v.morphTargetsCount),T.push(v.morphAttributeCount),T.push(v.numDirLights),T.push(v.numPointLights),T.push(v.numSpotLights),T.push(v.numSpotLightMaps),T.push(v.numHemiLights),T.push(v.numRectAreaLights),T.push(v.numDirLightShadows),T.push(v.numPointLightShadows),T.push(v.numSpotLightShadows),T.push(v.numSpotLightShadowsWithMaps),T.push(v.numLightProbes),T.push(v.shadowMapType),T.push(v.toneMapping),T.push(v.numClippingPlanes),T.push(v.numClipIntersection),T.push(v.depthPacking)}function M(T,v){a.disableAll(),v.supportsVertexTextures&&a.enable(0),v.instancing&&a.enable(1),v.instancingColor&&a.enable(2),v.instancingMorph&&a.enable(3),v.matcap&&a.enable(4),v.envMap&&a.enable(5),v.normalMapObjectSpace&&a.enable(6),v.normalMapTangentSpace&&a.enable(7),v.clearcoat&&a.enable(8),v.iridescence&&a.enable(9),v.alphaTest&&a.enable(10),v.vertexColors&&a.enable(11),v.vertexAlphas&&a.enable(12),v.vertexUv1s&&a.enable(13),v.vertexUv2s&&a.enable(14),v.vertexUv3s&&a.enable(15),v.vertexTangents&&a.enable(16),v.anisotropy&&a.enable(17),v.alphaHash&&a.enable(18),v.batching&&a.enable(19),v.dispersion&&a.enable(20),T.push(a.mask),a.disableAll(),v.fog&&a.enable(0),v.useFog&&a.enable(1),v.flatShading&&a.enable(2),v.logarithmicDepthBuffer&&a.enable(3),v.skinning&&a.enable(4),v.morphTargets&&a.enable(5),v.morphNormals&&a.enable(6),v.morphColors&&a.enable(7),v.premultipliedAlpha&&a.enable(8),v.shadowMapEnabled&&a.enable(9),v.useLegacyLights&&a.enable(10),v.doubleSided&&a.enable(11),v.flipSided&&a.enable(12),v.useDepthPacking&&a.enable(13),v.dithering&&a.enable(14),v.transmission&&a.enable(15),v.sheen&&a.enable(16),v.opaque&&a.enable(17),v.pointsUvs&&a.enable(18),v.decodeVideoTexture&&a.enable(19),v.alphaToCoverage&&a.enable(20),T.push(a.mask)}function A(T){const v=g[T.type];let X;if(v){const ee=di[v];X=y_.clone(ee.uniforms)}else X=T.uniforms;return X}function V(T,v){let X;for(let ee=0,I=u.length;ee<I;ee++){const J=u[ee];if(J.cacheKey===v){X=J,++X.usedTimes;break}}return X===void 0&&(X=new Py(i,v,T,o),u.push(X)),X}function b(T){if(--T.usedTimes===0){const v=u.indexOf(T);u[v]=u[u.length-1],u.pop(),T.destroy()}}function R(T){c.remove(T)}function B(){c.dispose()}return{getParameters:m,getProgramCacheKey:f,getUniforms:A,acquireProgram:V,releaseProgram:b,releaseShaderCache:R,programs:u,dispose:B}}function Fy(){let i=new WeakMap;function e(o){let r=i.get(o);return r===void 0&&(r={},i.set(o,r)),r}function t(o){i.delete(o)}function n(o,r,a){i.get(o)[r]=a}function s(){i=new WeakMap}return{get:e,remove:t,update:n,dispose:s}}function Vy(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function hh(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function dh(){const i=[];let e=0;const t=[],n=[],s=[];function o(){e=0,t.length=0,n.length=0,s.length=0}function r(h,d,p,g,x,m){let f=i[e];return f===void 0?(f={id:h.id,object:h,geometry:d,material:p,groupOrder:g,renderOrder:h.renderOrder,z:x,group:m},i[e]=f):(f.id=h.id,f.object=h,f.geometry=d,f.material=p,f.groupOrder=g,f.renderOrder=h.renderOrder,f.z=x,f.group=m),e++,f}function a(h,d,p,g,x,m){const f=r(h,d,p,g,x,m);p.transmission>0?n.push(f):p.transparent===!0?s.push(f):t.push(f)}function c(h,d,p,g,x,m){const f=r(h,d,p,g,x,m);p.transmission>0?n.unshift(f):p.transparent===!0?s.unshift(f):t.unshift(f)}function l(h,d){t.length>1&&t.sort(h||Vy),n.length>1&&n.sort(d||hh),s.length>1&&s.sort(d||hh)}function u(){for(let h=e,d=i.length;h<d;h++){const p=i[h];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:t,transmissive:n,transparent:s,init:o,push:a,unshift:c,finish:u,sort:l}}function zy(){let i=new WeakMap;function e(n,s){const o=i.get(n);let r;return o===void 0?(r=new dh,i.set(n,[r])):s>=o.length?(r=new dh,o.push(r)):r=o[s],r}function t(){i=new WeakMap}return{get:e,dispose:t}}function By(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new L,color:new Fe};break;case"SpotLight":t={position:new L,direction:new L,color:new Fe,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new L,color:new Fe,distance:0,decay:0};break;case"HemisphereLight":t={direction:new L,skyColor:new Fe,groundColor:new Fe};break;case"RectAreaLight":t={color:new Fe,position:new L,halfWidth:new L,halfHeight:new L};break}return i[e.id]=t,t}}}function Hy(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Te};break;case"SpotLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Te};break;case"PointLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Te,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let Gy=0;function ky(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function Wy(i){const e=new By,t=Hy(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new L);const s=new L,o=new Lt,r=new Lt;function a(l,u){let h=0,d=0,p=0;for(let X=0;X<9;X++)n.probe[X].set(0,0,0);let g=0,x=0,m=0,f=0,E=0,M=0,A=0,V=0,b=0,R=0,B=0;l.sort(ky);const T=u===!0?Math.PI:1;for(let X=0,ee=l.length;X<ee;X++){const I=l[X],J=I.color,ie=I.intensity,re=I.distance,me=I.shadow&&I.shadow.map?I.shadow.map.texture:null;if(I.isAmbientLight)h+=J.r*ie*T,d+=J.g*ie*T,p+=J.b*ie*T;else if(I.isLightProbe){for(let j=0;j<9;j++)n.probe[j].addScaledVector(I.sh.coefficients[j],ie);B++}else if(I.isDirectionalLight){const j=e.get(I);if(j.color.copy(I.color).multiplyScalar(I.intensity*T),I.castShadow){const le=I.shadow,ce=t.get(I);ce.shadowBias=le.bias,ce.shadowNormalBias=le.normalBias,ce.shadowRadius=le.radius,ce.shadowMapSize=le.mapSize,n.directionalShadow[g]=ce,n.directionalShadowMap[g]=me,n.directionalShadowMatrix[g]=I.shadow.matrix,M++}n.directional[g]=j,g++}else if(I.isSpotLight){const j=e.get(I);j.position.setFromMatrixPosition(I.matrixWorld),j.color.copy(J).multiplyScalar(ie*T),j.distance=re,j.coneCos=Math.cos(I.angle),j.penumbraCos=Math.cos(I.angle*(1-I.penumbra)),j.decay=I.decay,n.spot[m]=j;const le=I.shadow;if(I.map&&(n.spotLightMap[b]=I.map,b++,le.updateMatrices(I),I.castShadow&&R++),n.spotLightMatrix[m]=le.matrix,I.castShadow){const ce=t.get(I);ce.shadowBias=le.bias,ce.shadowNormalBias=le.normalBias,ce.shadowRadius=le.radius,ce.shadowMapSize=le.mapSize,n.spotShadow[m]=ce,n.spotShadowMap[m]=me,V++}m++}else if(I.isRectAreaLight){const j=e.get(I);j.color.copy(J).multiplyScalar(ie),j.halfWidth.set(I.width*.5,0,0),j.halfHeight.set(0,I.height*.5,0),n.rectArea[f]=j,f++}else if(I.isPointLight){const j=e.get(I);if(j.color.copy(I.color).multiplyScalar(I.intensity*T),j.distance=I.distance,j.decay=I.decay,I.castShadow){const le=I.shadow,ce=t.get(I);ce.shadowBias=le.bias,ce.shadowNormalBias=le.normalBias,ce.shadowRadius=le.radius,ce.shadowMapSize=le.mapSize,ce.shadowCameraNear=le.camera.near,ce.shadowCameraFar=le.camera.far,n.pointShadow[x]=ce,n.pointShadowMap[x]=me,n.pointShadowMatrix[x]=I.shadow.matrix,A++}n.point[x]=j,x++}else if(I.isHemisphereLight){const j=e.get(I);j.skyColor.copy(I.color).multiplyScalar(ie*T),j.groundColor.copy(I.groundColor).multiplyScalar(ie*T),n.hemi[E]=j,E++}}f>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=_e.LTC_FLOAT_1,n.rectAreaLTC2=_e.LTC_FLOAT_2):(n.rectAreaLTC1=_e.LTC_HALF_1,n.rectAreaLTC2=_e.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=d,n.ambient[2]=p;const v=n.hash;(v.directionalLength!==g||v.pointLength!==x||v.spotLength!==m||v.rectAreaLength!==f||v.hemiLength!==E||v.numDirectionalShadows!==M||v.numPointShadows!==A||v.numSpotShadows!==V||v.numSpotMaps!==b||v.numLightProbes!==B)&&(n.directional.length=g,n.spot.length=m,n.rectArea.length=f,n.point.length=x,n.hemi.length=E,n.directionalShadow.length=M,n.directionalShadowMap.length=M,n.pointShadow.length=A,n.pointShadowMap.length=A,n.spotShadow.length=V,n.spotShadowMap.length=V,n.directionalShadowMatrix.length=M,n.pointShadowMatrix.length=A,n.spotLightMatrix.length=V+b-R,n.spotLightMap.length=b,n.numSpotLightShadowsWithMaps=R,n.numLightProbes=B,v.directionalLength=g,v.pointLength=x,v.spotLength=m,v.rectAreaLength=f,v.hemiLength=E,v.numDirectionalShadows=M,v.numPointShadows=A,v.numSpotShadows=V,v.numSpotMaps=b,v.numLightProbes=B,n.version=Gy++)}function c(l,u){let h=0,d=0,p=0,g=0,x=0;const m=u.matrixWorldInverse;for(let f=0,E=l.length;f<E;f++){const M=l[f];if(M.isDirectionalLight){const A=n.directional[h];A.direction.setFromMatrixPosition(M.matrixWorld),s.setFromMatrixPosition(M.target.matrixWorld),A.direction.sub(s),A.direction.transformDirection(m),h++}else if(M.isSpotLight){const A=n.spot[p];A.position.setFromMatrixPosition(M.matrixWorld),A.position.applyMatrix4(m),A.direction.setFromMatrixPosition(M.matrixWorld),s.setFromMatrixPosition(M.target.matrixWorld),A.direction.sub(s),A.direction.transformDirection(m),p++}else if(M.isRectAreaLight){const A=n.rectArea[g];A.position.setFromMatrixPosition(M.matrixWorld),A.position.applyMatrix4(m),r.identity(),o.copy(M.matrixWorld),o.premultiply(m),r.extractRotation(o),A.halfWidth.set(M.width*.5,0,0),A.halfHeight.set(0,M.height*.5,0),A.halfWidth.applyMatrix4(r),A.halfHeight.applyMatrix4(r),g++}else if(M.isPointLight){const A=n.point[d];A.position.setFromMatrixPosition(M.matrixWorld),A.position.applyMatrix4(m),d++}else if(M.isHemisphereLight){const A=n.hemi[x];A.direction.setFromMatrixPosition(M.matrixWorld),A.direction.transformDirection(m),x++}}}return{setup:a,setupView:c,state:n}}function fh(i){const e=new Wy(i),t=[],n=[];function s(u){l.camera=u,t.length=0,n.length=0}function o(u){t.push(u)}function r(u){n.push(u)}function a(u){e.setup(t,u)}function c(u){e.setupView(t,u)}const l={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:s,state:l,setupLights:a,setupLightsView:c,pushLight:o,pushShadow:r}}function Xy(i){let e=new WeakMap;function t(s,o=0){const r=e.get(s);let a;return r===void 0?(a=new fh(i),e.set(s,[a])):o>=r.length?(a=new fh(i),r.push(a)):a=r[o],a}function n(){e=new WeakMap}return{get:t,dispose:n}}class qy extends On{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=Ig,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class Yy extends On{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const jy=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function Zy(i,e,t){let n=new vl;const s=new Te,o=new Te,r=new at,a=new qy({depthPacking:Dg}),c=new Yy,l={},u=t.maxTextureSize,h={[ns]:_n,[_n]:ns,[Li]:Li},d=new Oi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Te},radius:{value:4}},vertexShader:jy,fragmentShader:$y}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const g=new cs;g.setAttribute("position",new Wn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new ni(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ed;let f=this.type;this.render=function(b,R,B){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||b.length===0)return;const T=i.getRenderTarget(),v=i.getActiveCubeFace(),X=i.getActiveMipmapLevel(),ee=i.state;ee.setBlending(ts),ee.buffers.color.setClear(1,1,1,1),ee.buffers.depth.setTest(!0),ee.setScissorTest(!1);const I=f!==wi&&this.type===wi,J=f===wi&&this.type!==wi;for(let ie=0,re=b.length;ie<re;ie++){const me=b[ie],j=me.shadow;if(j===void 0){console.warn("THREE.WebGLShadowMap:",me,"has no shadow.");continue}if(j.autoUpdate===!1&&j.needsUpdate===!1)continue;s.copy(j.mapSize);const le=j.getFrameExtents();if(s.multiply(le),o.copy(j.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(o.x=Math.floor(u/le.x),s.x=o.x*le.x,j.mapSize.x=o.x),s.y>u&&(o.y=Math.floor(u/le.y),s.y=o.y*le.y,j.mapSize.y=o.y)),j.map===null||I===!0||J===!0){const be=this.type!==wi?{minFilter:fn,magFilter:fn}:{};j.map!==null&&j.map.dispose(),j.map=new Ns(s.x,s.y,be),j.map.texture.name=me.name+".shadowMap",j.camera.updateProjectionMatrix()}i.setRenderTarget(j.map),i.clear();const ce=j.getViewportCount();for(let be=0;be<ce;be++){const et=j.getViewport(be);r.set(o.x*et.x,o.y*et.y,o.x*et.z,o.y*et.w),ee.viewport(r),j.updateMatrices(me,be),n=j.getFrustum(),A(R,B,j.camera,me,this.type)}j.isPointLightShadow!==!0&&this.type===wi&&E(j,B),j.needsUpdate=!1}f=this.type,m.needsUpdate=!1,i.setRenderTarget(T,v,X)};function E(b,R){const B=e.update(x);d.defines.VSM_SAMPLES!==b.blurSamples&&(d.defines.VSM_SAMPLES=b.blurSamples,p.defines.VSM_SAMPLES=b.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new Ns(s.x,s.y)),d.uniforms.shadow_pass.value=b.map.texture,d.uniforms.resolution.value=b.mapSize,d.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(R,null,B,d,x,null),p.uniforms.shadow_pass.value=b.mapPass.texture,p.uniforms.resolution.value=b.mapSize,p.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(R,null,B,p,x,null)}function M(b,R,B,T){let v=null;const X=B.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(X!==void 0)v=X;else if(v=B.isPointLight===!0?c:a,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const ee=v.uuid,I=R.uuid;let J=l[ee];J===void 0&&(J={},l[ee]=J);let ie=J[I];ie===void 0&&(ie=v.clone(),J[I]=ie,R.addEventListener("dispose",V)),v=ie}if(v.visible=R.visible,v.wireframe=R.wireframe,T===wi?v.side=R.shadowSide!==null?R.shadowSide:R.side:v.side=R.shadowSide!==null?R.shadowSide:h[R.side],v.alphaMap=R.alphaMap,v.alphaTest=R.alphaTest,v.map=R.map,v.clipShadows=R.clipShadows,v.clippingPlanes=R.clippingPlanes,v.clipIntersection=R.clipIntersection,v.displacementMap=R.displacementMap,v.displacementScale=R.displacementScale,v.displacementBias=R.displacementBias,v.wireframeLinewidth=R.wireframeLinewidth,v.linewidth=R.linewidth,B.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const ee=i.properties.get(v);ee.light=B}return v}function A(b,R,B,T,v){if(b.visible===!1)return;if(b.layers.test(R.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&v===wi)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse,b.matrixWorld);const I=e.update(b),J=b.material;if(Array.isArray(J)){const ie=I.groups;for(let re=0,me=ie.length;re<me;re++){const j=ie[re],le=J[j.materialIndex];if(le&&le.visible){const ce=M(b,le,T,v);b.onBeforeShadow(i,b,R,B,I,ce,j),i.renderBufferDirect(B,null,I,ce,b,j),b.onAfterShadow(i,b,R,B,I,ce,j)}}}else if(J.visible){const ie=M(b,J,T,v);b.onBeforeShadow(i,b,R,B,I,ie,null),i.renderBufferDirect(B,null,I,ie,b,null),b.onAfterShadow(i,b,R,B,I,ie,null)}}const ee=b.children;for(let I=0,J=ee.length;I<J;I++)A(ee[I],R,B,T,v)}function V(b){b.target.removeEventListener("dispose",V);for(const B in l){const T=l[B],v=b.target.uuid;v in T&&(T[v].dispose(),delete T[v])}}}function Ky(i){function e(){let _=!1;const O=new at;let H=null;const se=new at(0,0,0,0);return{setMask:function(he){H!==he&&!_&&(i.colorMask(he,he,he,he),H=he)},setLocked:function(he){_=he},setClear:function(he,We,Ke,It,Kt){Kt===!0&&(he*=It,We*=It,Ke*=It),O.set(he,We,Ke,It),se.equals(O)===!1&&(i.clearColor(he,We,Ke,It),se.copy(O))},reset:function(){_=!1,H=null,se.set(-1,0,0,0)}}}function t(){let _=!1,O=null,H=null,se=null;return{setTest:function(he){he?Se(i.DEPTH_TEST):ge(i.DEPTH_TEST)},setMask:function(he){O!==he&&!_&&(i.depthMask(he),O=he)},setFunc:function(he){if(H!==he){switch(he){case hg:i.depthFunc(i.NEVER);break;case dg:i.depthFunc(i.ALWAYS);break;case fg:i.depthFunc(i.LESS);break;case Wr:i.depthFunc(i.LEQUAL);break;case pg:i.depthFunc(i.EQUAL);break;case mg:i.depthFunc(i.GEQUAL);break;case gg:i.depthFunc(i.GREATER);break;case _g:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}H=he}},setLocked:function(he){_=he},setClear:function(he){se!==he&&(i.clearDepth(he),se=he)},reset:function(){_=!1,O=null,H=null,se=null}}}function n(){let _=!1,O=null,H=null,se=null,he=null,We=null,Ke=null,It=null,Kt=null;return{setTest:function(rt){_||(rt?Se(i.STENCIL_TEST):ge(i.STENCIL_TEST))},setMask:function(rt){O!==rt&&!_&&(i.stencilMask(rt),O=rt)},setFunc:function(rt,Bt,Nt){(H!==rt||se!==Bt||he!==Nt)&&(i.stencilFunc(rt,Bt,Nt),H=rt,se=Bt,he=Nt)},setOp:function(rt,Bt,Nt){(We!==rt||Ke!==Bt||It!==Nt)&&(i.stencilOp(rt,Bt,Nt),We=rt,Ke=Bt,It=Nt)},setLocked:function(rt){_=rt},setClear:function(rt){Kt!==rt&&(i.clearStencil(rt),Kt=rt)},reset:function(){_=!1,O=null,H=null,se=null,he=null,We=null,Ke=null,It=null,Kt=null}}}const s=new e,o=new t,r=new n,a=new WeakMap,c=new WeakMap;let l={},u={},h=new WeakMap,d=[],p=null,g=!1,x=null,m=null,f=null,E=null,M=null,A=null,V=null,b=new Fe(0,0,0),R=0,B=!1,T=null,v=null,X=null,ee=null,I=null;const J=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let ie=!1,re=0;const me=i.getParameter(i.VERSION);me.indexOf("WebGL")!==-1?(re=parseFloat(/^WebGL (\d)/.exec(me)[1]),ie=re>=1):me.indexOf("OpenGL ES")!==-1&&(re=parseFloat(/^OpenGL ES (\d)/.exec(me)[1]),ie=re>=2);let j=null,le={};const ce=i.getParameter(i.SCISSOR_BOX),be=i.getParameter(i.VIEWPORT),et=new at().fromArray(ce),dt=new at().fromArray(be);function K(_,O,H,se){const he=new Uint8Array(4),We=i.createTexture();i.bindTexture(_,We),i.texParameteri(_,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(_,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ke=0;Ke<H;Ke++)_===i.TEXTURE_3D||_===i.TEXTURE_2D_ARRAY?i.texImage3D(O,0,i.RGBA,1,1,se,0,i.RGBA,i.UNSIGNED_BYTE,he):i.texImage2D(O+Ke,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,he);return We}const ue={};ue[i.TEXTURE_2D]=K(i.TEXTURE_2D,i.TEXTURE_2D,1),ue[i.TEXTURE_CUBE_MAP]=K(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ue[i.TEXTURE_2D_ARRAY]=K(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ue[i.TEXTURE_3D]=K(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),r.setClear(0),Se(i.DEPTH_TEST),o.setFunc(Wr),nt(!1),Ge(jl),Se(i.CULL_FACE),xt(ts);function Se(_){l[_]!==!0&&(i.enable(_),l[_]=!0)}function ge(_){l[_]!==!1&&(i.disable(_),l[_]=!1)}function tt(_,O){return u[_]!==O?(i.bindFramebuffer(_,O),u[_]=O,_===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=O),_===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=O),!0):!1}function $e(_,O){let H=d,se=!1;if(_){H=h.get(O),H===void 0&&(H=[],h.set(O,H));const he=_.textures;if(H.length!==he.length||H[0]!==i.COLOR_ATTACHMENT0){for(let We=0,Ke=he.length;We<Ke;We++)H[We]=i.COLOR_ATTACHMENT0+We;H.length=he.length,se=!0}}else H[0]!==i.BACK&&(H[0]=i.BACK,se=!0);se&&i.drawBuffers(H)}function z(_){return p!==_?(i.useProgram(_),p=_,!0):!1}const _t={[ys]:i.FUNC_ADD,[jm]:i.FUNC_SUBTRACT,[$m]:i.FUNC_REVERSE_SUBTRACT};_t[Zm]=i.MIN,_t[Km]=i.MAX;const Pe={[Jm]:i.ZERO,[Qm]:i.ONE,[eg]:i.SRC_COLOR,[Vc]:i.SRC_ALPHA,[rg]:i.SRC_ALPHA_SATURATE,[sg]:i.DST_COLOR,[ng]:i.DST_ALPHA,[tg]:i.ONE_MINUS_SRC_COLOR,[zc]:i.ONE_MINUS_SRC_ALPHA,[og]:i.ONE_MINUS_DST_COLOR,[ig]:i.ONE_MINUS_DST_ALPHA,[ag]:i.CONSTANT_COLOR,[cg]:i.ONE_MINUS_CONSTANT_COLOR,[lg]:i.CONSTANT_ALPHA,[ug]:i.ONE_MINUS_CONSTANT_ALPHA};function xt(_,O,H,se,he,We,Ke,It,Kt,rt){if(_===ts){g===!0&&(ge(i.BLEND),g=!1);return}if(g===!1&&(Se(i.BLEND),g=!0),_!==Ym){if(_!==x||rt!==B){if((m!==ys||M!==ys)&&(i.blendEquation(i.FUNC_ADD),m=ys,M=ys),rt)switch(_){case so:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case $l:i.blendFunc(i.ONE,i.ONE);break;case Zl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Kl:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",_);break}else switch(_){case so:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case $l:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Zl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Kl:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",_);break}f=null,E=null,A=null,V=null,b.set(0,0,0),R=0,x=_,B=rt}return}he=he||O,We=We||H,Ke=Ke||se,(O!==m||he!==M)&&(i.blendEquationSeparate(_t[O],_t[he]),m=O,M=he),(H!==f||se!==E||We!==A||Ke!==V)&&(i.blendFuncSeparate(Pe[H],Pe[se],Pe[We],Pe[Ke]),f=H,E=se,A=We,V=Ke),(It.equals(b)===!1||Kt!==R)&&(i.blendColor(It.r,It.g,It.b,Kt),b.copy(It),R=Kt),x=_,B=!1}function De(_,O){_.side===Li?ge(i.CULL_FACE):Se(i.CULL_FACE);let H=_.side===_n;O&&(H=!H),nt(H),_.blending===so&&_.transparent===!1?xt(ts):xt(_.blending,_.blendEquation,_.blendSrc,_.blendDst,_.blendEquationAlpha,_.blendSrcAlpha,_.blendDstAlpha,_.blendColor,_.blendAlpha,_.premultipliedAlpha),o.setFunc(_.depthFunc),o.setTest(_.depthTest),o.setMask(_.depthWrite),s.setMask(_.colorWrite);const se=_.stencilWrite;r.setTest(se),se&&(r.setMask(_.stencilWriteMask),r.setFunc(_.stencilFunc,_.stencilRef,_.stencilFuncMask),r.setOp(_.stencilFail,_.stencilZFail,_.stencilZPass)),Rt(_.polygonOffset,_.polygonOffsetFactor,_.polygonOffsetUnits),_.alphaToCoverage===!0?Se(i.SAMPLE_ALPHA_TO_COVERAGE):ge(i.SAMPLE_ALPHA_TO_COVERAGE)}function nt(_){T!==_&&(_?i.frontFace(i.CW):i.frontFace(i.CCW),T=_)}function Ge(_){_!==Wm?(Se(i.CULL_FACE),_!==v&&(_===jl?i.cullFace(i.BACK):_===Xm?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ge(i.CULL_FACE),v=_}function it(_){_!==X&&(ie&&i.lineWidth(_),X=_)}function Rt(_,O,H){_?(Se(i.POLYGON_OFFSET_FILL),(ee!==O||I!==H)&&(i.polygonOffset(O,H),ee=O,I=H)):ge(i.POLYGON_OFFSET_FILL)}function w(_){_?Se(i.SCISSOR_TEST):ge(i.SCISSOR_TEST)}function y(_){_===void 0&&(_=i.TEXTURE0+J-1),j!==_&&(i.activeTexture(_),j=_)}function Y(_,O,H){H===void 0&&(j===null?H=i.TEXTURE0+J-1:H=j);let se=le[H];se===void 0&&(se={type:void 0,texture:void 0},le[H]=se),(se.type!==_||se.texture!==O)&&(j!==H&&(i.activeTexture(H),j=H),i.bindTexture(_,O||ue[_]),se.type=_,se.texture=O)}function ne(){const _=le[j];_!==void 0&&_.type!==void 0&&(i.bindTexture(_.type,null),_.type=void 0,_.texture=void 0)}function oe(){try{i.compressedTexImage2D.apply(i,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function ae(){try{i.compressedTexImage3D.apply(i,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function Le(){try{i.texSubImage2D.apply(i,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function ve(){try{i.texSubImage3D.apply(i,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function xe(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function Ve(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function de(){try{i.texStorage2D.apply(i,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function Ce(){try{i.texStorage3D.apply(i,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function st(){try{i.texImage2D.apply(i,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function Ie(){try{i.texImage3D.apply(i,arguments)}catch(_){console.error("THREE.WebGLState:",_)}}function Me(_){et.equals(_)===!1&&(i.scissor(_.x,_.y,_.z,_.w),et.copy(_))}function ke(_){dt.equals(_)===!1&&(i.viewport(_.x,_.y,_.z,_.w),dt.copy(_))}function Ze(_,O){let H=c.get(O);H===void 0&&(H=new WeakMap,c.set(O,H));let se=H.get(_);se===void 0&&(se=i.getUniformBlockIndex(O,_.name),H.set(_,se))}function vt(_,O){const se=c.get(O).get(_);a.get(O)!==se&&(i.uniformBlockBinding(O,se,_.__bindingPointIndex),a.set(O,se))}function qe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),l={},j=null,le={},u={},h=new WeakMap,d=[],p=null,g=!1,x=null,m=null,f=null,E=null,M=null,A=null,V=null,b=new Fe(0,0,0),R=0,B=!1,T=null,v=null,X=null,ee=null,I=null,et.set(0,0,i.canvas.width,i.canvas.height),dt.set(0,0,i.canvas.width,i.canvas.height),s.reset(),o.reset(),r.reset()}return{buffers:{color:s,depth:o,stencil:r},enable:Se,disable:ge,bindFramebuffer:tt,drawBuffers:$e,useProgram:z,setBlending:xt,setMaterial:De,setFlipSided:nt,setCullFace:Ge,setLineWidth:it,setPolygonOffset:Rt,setScissorTest:w,activeTexture:y,bindTexture:Y,unbindTexture:ne,compressedTexImage2D:oe,compressedTexImage3D:ae,texImage2D:st,texImage3D:Ie,updateUBOMapping:Ze,uniformBlockBinding:vt,texStorage2D:de,texStorage3D:Ce,texSubImage2D:Le,texSubImage3D:ve,compressedTexSubImage2D:xe,compressedTexSubImage3D:Ve,scissor:Me,viewport:ke,reset:qe}}function Jy(i,e,t,n,s,o,r){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Te,u=new WeakMap;let h;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(w,y){return p?new OffscreenCanvas(w,y):$r("canvas")}function x(w,y,Y){let ne=1;const oe=Rt(w);if((oe.width>Y||oe.height>Y)&&(ne=Y/Math.max(oe.width,oe.height)),ne<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const ae=Math.floor(ne*oe.width),Le=Math.floor(ne*oe.height);h===void 0&&(h=g(ae,Le));const ve=y?g(ae,Le):h;return ve.width=ae,ve.height=Le,ve.getContext("2d").drawImage(w,0,0,ae,Le),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+oe.width+"x"+oe.height+") to ("+ae+"x"+Le+")."),ve}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+oe.width+"x"+oe.height+")."),w;return w}function m(w){return w.generateMipmaps&&w.minFilter!==fn&&w.minFilter!==Qn}function f(w){i.generateMipmap(w)}function E(w,y,Y,ne,oe=!1){if(w!==null){if(i[w]!==void 0)return i[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let ae=y;if(y===i.RED&&(Y===i.FLOAT&&(ae=i.R32F),Y===i.HALF_FLOAT&&(ae=i.R16F),Y===i.UNSIGNED_BYTE&&(ae=i.R8)),y===i.RED_INTEGER&&(Y===i.UNSIGNED_BYTE&&(ae=i.R8UI),Y===i.UNSIGNED_SHORT&&(ae=i.R16UI),Y===i.UNSIGNED_INT&&(ae=i.R32UI),Y===i.BYTE&&(ae=i.R8I),Y===i.SHORT&&(ae=i.R16I),Y===i.INT&&(ae=i.R32I)),y===i.RG&&(Y===i.FLOAT&&(ae=i.RG32F),Y===i.HALF_FLOAT&&(ae=i.RG16F),Y===i.UNSIGNED_BYTE&&(ae=i.RG8)),y===i.RG_INTEGER&&(Y===i.UNSIGNED_BYTE&&(ae=i.RG8UI),Y===i.UNSIGNED_SHORT&&(ae=i.RG16UI),Y===i.UNSIGNED_INT&&(ae=i.RG32UI),Y===i.BYTE&&(ae=i.RG8I),Y===i.SHORT&&(ae=i.RG16I),Y===i.INT&&(ae=i.RG32I)),y===i.RGB&&Y===i.UNSIGNED_INT_5_9_9_9_REV&&(ae=i.RGB9_E5),y===i.RGBA){const Le=oe?Xr:yt.getTransfer(ne);Y===i.FLOAT&&(ae=i.RGBA32F),Y===i.HALF_FLOAT&&(ae=i.RGBA16F),Y===i.UNSIGNED_BYTE&&(ae=Le===bt?i.SRGB8_ALPHA8:i.RGBA8),Y===i.UNSIGNED_SHORT_4_4_4_4&&(ae=i.RGBA4),Y===i.UNSIGNED_SHORT_5_5_5_1&&(ae=i.RGB5_A1)}return(ae===i.R16F||ae===i.R32F||ae===i.RG16F||ae===i.RG32F||ae===i.RGBA16F||ae===i.RGBA32F)&&e.get("EXT_color_buffer_float"),ae}function M(w,y){return m(w)===!0||w.isFramebufferTexture&&w.minFilter!==fn&&w.minFilter!==Qn?Math.log2(Math.max(y.width,y.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?y.mipmaps.length:1}function A(w){const y=w.target;y.removeEventListener("dispose",A),b(y),y.isVideoTexture&&u.delete(y)}function V(w){const y=w.target;y.removeEventListener("dispose",V),B(y)}function b(w){const y=n.get(w);if(y.__webglInit===void 0)return;const Y=w.source,ne=d.get(Y);if(ne){const oe=ne[y.__cacheKey];oe.usedTimes--,oe.usedTimes===0&&R(w),Object.keys(ne).length===0&&d.delete(Y)}n.remove(w)}function R(w){const y=n.get(w);i.deleteTexture(y.__webglTexture);const Y=w.source,ne=d.get(Y);delete ne[y.__cacheKey],r.memory.textures--}function B(w){const y=n.get(w);if(w.depthTexture&&w.depthTexture.dispose(),w.isWebGLCubeRenderTarget)for(let ne=0;ne<6;ne++){if(Array.isArray(y.__webglFramebuffer[ne]))for(let oe=0;oe<y.__webglFramebuffer[ne].length;oe++)i.deleteFramebuffer(y.__webglFramebuffer[ne][oe]);else i.deleteFramebuffer(y.__webglFramebuffer[ne]);y.__webglDepthbuffer&&i.deleteRenderbuffer(y.__webglDepthbuffer[ne])}else{if(Array.isArray(y.__webglFramebuffer))for(let ne=0;ne<y.__webglFramebuffer.length;ne++)i.deleteFramebuffer(y.__webglFramebuffer[ne]);else i.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&i.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&i.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let ne=0;ne<y.__webglColorRenderbuffer.length;ne++)y.__webglColorRenderbuffer[ne]&&i.deleteRenderbuffer(y.__webglColorRenderbuffer[ne]);y.__webglDepthRenderbuffer&&i.deleteRenderbuffer(y.__webglDepthRenderbuffer)}const Y=w.textures;for(let ne=0,oe=Y.length;ne<oe;ne++){const ae=n.get(Y[ne]);ae.__webglTexture&&(i.deleteTexture(ae.__webglTexture),r.memory.textures--),n.remove(Y[ne])}n.remove(w)}let T=0;function v(){T=0}function X(){const w=T;return w>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+s.maxTextures),T+=1,w}function ee(w){const y=[];return y.push(w.wrapS),y.push(w.wrapT),y.push(w.wrapR||0),y.push(w.magFilter),y.push(w.minFilter),y.push(w.anisotropy),y.push(w.internalFormat),y.push(w.format),y.push(w.type),y.push(w.generateMipmaps),y.push(w.premultiplyAlpha),y.push(w.flipY),y.push(w.unpackAlignment),y.push(w.colorSpace),y.join()}function I(w,y){const Y=n.get(w);if(w.isVideoTexture&&Ge(w),w.isRenderTargetTexture===!1&&w.version>0&&Y.__version!==w.version){const ne=w.image;if(ne===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ne.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{et(Y,w,y);return}}t.bindTexture(i.TEXTURE_2D,Y.__webglTexture,i.TEXTURE0+y)}function J(w,y){const Y=n.get(w);if(w.version>0&&Y.__version!==w.version){et(Y,w,y);return}t.bindTexture(i.TEXTURE_2D_ARRAY,Y.__webglTexture,i.TEXTURE0+y)}function ie(w,y){const Y=n.get(w);if(w.version>0&&Y.__version!==w.version){et(Y,w,y);return}t.bindTexture(i.TEXTURE_3D,Y.__webglTexture,i.TEXTURE0+y)}function re(w,y){const Y=n.get(w);if(w.version>0&&Y.__version!==w.version){dt(Y,w,y);return}t.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture,i.TEXTURE0+y)}const me={[Gc]:i.REPEAT,[Ts]:i.CLAMP_TO_EDGE,[kc]:i.MIRRORED_REPEAT},j={[fn]:i.NEAREST,[Sg]:i.NEAREST_MIPMAP_NEAREST,[fr]:i.NEAREST_MIPMAP_LINEAR,[Qn]:i.LINEAR,[Da]:i.LINEAR_MIPMAP_NEAREST,[Ji]:i.LINEAR_MIPMAP_LINEAR},le={[Ug]:i.NEVER,[Bg]:i.ALWAYS,[md]:i.LESS,[gd]:i.LEQUAL,[Og]:i.EQUAL,[zg]:i.GEQUAL,[Fg]:i.GREATER,[Vg]:i.NOTEQUAL};function ce(w,y){if(y.type===Pi&&e.has("OES_texture_float_linear")===!1&&(y.magFilter===Qn||y.magFilter===Da||y.magFilter===fr||y.magFilter===Ji||y.minFilter===Qn||y.minFilter===Da||y.minFilter===fr||y.minFilter===Ji)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(w,i.TEXTURE_WRAP_S,me[y.wrapS]),i.texParameteri(w,i.TEXTURE_WRAP_T,me[y.wrapT]),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,me[y.wrapR]),i.texParameteri(w,i.TEXTURE_MAG_FILTER,j[y.magFilter]),i.texParameteri(w,i.TEXTURE_MIN_FILTER,j[y.minFilter]),y.compareFunction&&(i.texParameteri(w,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(w,i.TEXTURE_COMPARE_FUNC,le[y.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===fn||y.minFilter!==fr&&y.minFilter!==Ji||y.type===Pi&&e.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||n.get(y).__currentAnisotropy){const Y=e.get("EXT_texture_filter_anisotropic");i.texParameterf(w,Y.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,s.getMaxAnisotropy())),n.get(y).__currentAnisotropy=y.anisotropy}}}function be(w,y){let Y=!1;w.__webglInit===void 0&&(w.__webglInit=!0,y.addEventListener("dispose",A));const ne=y.source;let oe=d.get(ne);oe===void 0&&(oe={},d.set(ne,oe));const ae=ee(y);if(ae!==w.__cacheKey){oe[ae]===void 0&&(oe[ae]={texture:i.createTexture(),usedTimes:0},r.memory.textures++,Y=!0),oe[ae].usedTimes++;const Le=oe[w.__cacheKey];Le!==void 0&&(oe[w.__cacheKey].usedTimes--,Le.usedTimes===0&&R(y)),w.__cacheKey=ae,w.__webglTexture=oe[ae].texture}return Y}function et(w,y,Y){let ne=i.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&(ne=i.TEXTURE_2D_ARRAY),y.isData3DTexture&&(ne=i.TEXTURE_3D);const oe=be(w,y),ae=y.source;t.bindTexture(ne,w.__webglTexture,i.TEXTURE0+Y);const Le=n.get(ae);if(ae.version!==Le.__version||oe===!0){t.activeTexture(i.TEXTURE0+Y);const ve=yt.getPrimaries(yt.workingColorSpace),xe=y.colorSpace===Ki?null:yt.getPrimaries(y.colorSpace),Ve=y.colorSpace===Ki||ve===xe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,y.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,y.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ve);let de=x(y.image,!1,s.maxTextureSize);de=it(y,de);const Ce=o.convert(y.format,y.colorSpace),st=o.convert(y.type);let Ie=E(y.internalFormat,Ce,st,y.colorSpace,y.isVideoTexture);ce(ne,y);let Me;const ke=y.mipmaps,Ze=y.isVideoTexture!==!0,vt=Le.__version===void 0||oe===!0,qe=ae.dataReady,_=M(y,de);if(y.isDepthTexture)Ie=i.DEPTH_COMPONENT16,y.type===Pi?Ie=i.DEPTH_COMPONENT32F:y.type===go?Ie=i.DEPTH_COMPONENT24:y.type===ir&&(Ie=i.DEPTH24_STENCIL8),vt&&(Ze?t.texStorage2D(i.TEXTURE_2D,1,Ie,de.width,de.height):t.texImage2D(i.TEXTURE_2D,0,Ie,de.width,de.height,0,Ce,st,null));else if(y.isDataTexture)if(ke.length>0){Ze&&vt&&t.texStorage2D(i.TEXTURE_2D,_,Ie,ke[0].width,ke[0].height);for(let O=0,H=ke.length;O<H;O++)Me=ke[O],Ze?qe&&t.texSubImage2D(i.TEXTURE_2D,O,0,0,Me.width,Me.height,Ce,st,Me.data):t.texImage2D(i.TEXTURE_2D,O,Ie,Me.width,Me.height,0,Ce,st,Me.data);y.generateMipmaps=!1}else Ze?(vt&&t.texStorage2D(i.TEXTURE_2D,_,Ie,de.width,de.height),qe&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,de.width,de.height,Ce,st,de.data)):t.texImage2D(i.TEXTURE_2D,0,Ie,de.width,de.height,0,Ce,st,de.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){Ze&&vt&&t.texStorage3D(i.TEXTURE_2D_ARRAY,_,Ie,ke[0].width,ke[0].height,de.depth);for(let O=0,H=ke.length;O<H;O++)Me=ke[O],y.format!==gi?Ce!==null?Ze?qe&&t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,O,0,0,0,Me.width,Me.height,de.depth,Ce,Me.data,0,0):t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,O,Ie,Me.width,Me.height,de.depth,0,Me.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ze?qe&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,O,0,0,0,Me.width,Me.height,de.depth,Ce,st,Me.data):t.texImage3D(i.TEXTURE_2D_ARRAY,O,Ie,Me.width,Me.height,de.depth,0,Ce,st,Me.data)}else{Ze&&vt&&t.texStorage2D(i.TEXTURE_2D,_,Ie,ke[0].width,ke[0].height);for(let O=0,H=ke.length;O<H;O++)Me=ke[O],y.format!==gi?Ce!==null?Ze?qe&&t.compressedTexSubImage2D(i.TEXTURE_2D,O,0,0,Me.width,Me.height,Ce,Me.data):t.compressedTexImage2D(i.TEXTURE_2D,O,Ie,Me.width,Me.height,0,Me.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ze?qe&&t.texSubImage2D(i.TEXTURE_2D,O,0,0,Me.width,Me.height,Ce,st,Me.data):t.texImage2D(i.TEXTURE_2D,O,Ie,Me.width,Me.height,0,Ce,st,Me.data)}else if(y.isDataArrayTexture)Ze?(vt&&t.texStorage3D(i.TEXTURE_2D_ARRAY,_,Ie,de.width,de.height,de.depth),qe&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,de.width,de.height,de.depth,Ce,st,de.data)):t.texImage3D(i.TEXTURE_2D_ARRAY,0,Ie,de.width,de.height,de.depth,0,Ce,st,de.data);else if(y.isData3DTexture)Ze?(vt&&t.texStorage3D(i.TEXTURE_3D,_,Ie,de.width,de.height,de.depth),qe&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,de.width,de.height,de.depth,Ce,st,de.data)):t.texImage3D(i.TEXTURE_3D,0,Ie,de.width,de.height,de.depth,0,Ce,st,de.data);else if(y.isFramebufferTexture){if(vt)if(Ze)t.texStorage2D(i.TEXTURE_2D,_,Ie,de.width,de.height);else{let O=de.width,H=de.height;for(let se=0;se<_;se++)t.texImage2D(i.TEXTURE_2D,se,Ie,O,H,0,Ce,st,null),O>>=1,H>>=1}}else if(ke.length>0){if(Ze&&vt){const O=Rt(ke[0]);t.texStorage2D(i.TEXTURE_2D,_,Ie,O.width,O.height)}for(let O=0,H=ke.length;O<H;O++)Me=ke[O],Ze?qe&&t.texSubImage2D(i.TEXTURE_2D,O,0,0,Ce,st,Me):t.texImage2D(i.TEXTURE_2D,O,Ie,Ce,st,Me);y.generateMipmaps=!1}else if(Ze){if(vt){const O=Rt(de);t.texStorage2D(i.TEXTURE_2D,_,Ie,O.width,O.height)}qe&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Ce,st,de)}else t.texImage2D(i.TEXTURE_2D,0,Ie,Ce,st,de);m(y)&&f(ne),Le.__version=ae.version,y.onUpdate&&y.onUpdate(y)}w.__version=y.version}function dt(w,y,Y){if(y.image.length!==6)return;const ne=be(w,y),oe=y.source;t.bindTexture(i.TEXTURE_CUBE_MAP,w.__webglTexture,i.TEXTURE0+Y);const ae=n.get(oe);if(oe.version!==ae.__version||ne===!0){t.activeTexture(i.TEXTURE0+Y);const Le=yt.getPrimaries(yt.workingColorSpace),ve=y.colorSpace===Ki?null:yt.getPrimaries(y.colorSpace),xe=y.colorSpace===Ki||Le===ve?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,y.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,y.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe);const Ve=y.isCompressedTexture||y.image[0].isCompressedTexture,de=y.image[0]&&y.image[0].isDataTexture,Ce=[];for(let H=0;H<6;H++)!Ve&&!de?Ce[H]=x(y.image[H],!0,s.maxCubemapSize):Ce[H]=de?y.image[H].image:y.image[H],Ce[H]=it(y,Ce[H]);const st=Ce[0],Ie=o.convert(y.format,y.colorSpace),Me=o.convert(y.type),ke=E(y.internalFormat,Ie,Me,y.colorSpace),Ze=y.isVideoTexture!==!0,vt=ae.__version===void 0||ne===!0,qe=oe.dataReady;let _=M(y,st);ce(i.TEXTURE_CUBE_MAP,y);let O;if(Ve){Ze&&vt&&t.texStorage2D(i.TEXTURE_CUBE_MAP,_,ke,st.width,st.height);for(let H=0;H<6;H++){O=Ce[H].mipmaps;for(let se=0;se<O.length;se++){const he=O[se];y.format!==gi?Ie!==null?Ze?qe&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,se,0,0,he.width,he.height,Ie,he.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,se,ke,he.width,he.height,0,he.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ze?qe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,se,0,0,he.width,he.height,Ie,Me,he.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,se,ke,he.width,he.height,0,Ie,Me,he.data)}}}else{if(O=y.mipmaps,Ze&&vt){O.length>0&&_++;const H=Rt(Ce[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,_,ke,H.width,H.height)}for(let H=0;H<6;H++)if(de){Ze?qe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,0,0,0,Ce[H].width,Ce[H].height,Ie,Me,Ce[H].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,0,ke,Ce[H].width,Ce[H].height,0,Ie,Me,Ce[H].data);for(let se=0;se<O.length;se++){const We=O[se].image[H].image;Ze?qe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,se+1,0,0,We.width,We.height,Ie,Me,We.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,se+1,ke,We.width,We.height,0,Ie,Me,We.data)}}else{Ze?qe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,0,0,0,Ie,Me,Ce[H]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,0,ke,Ie,Me,Ce[H]);for(let se=0;se<O.length;se++){const he=O[se];Ze?qe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,se+1,0,0,Ie,Me,he.image[H]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+H,se+1,ke,Ie,Me,he.image[H])}}}m(y)&&f(i.TEXTURE_CUBE_MAP),ae.__version=oe.version,y.onUpdate&&y.onUpdate(y)}w.__version=y.version}function K(w,y,Y,ne,oe,ae){const Le=o.convert(Y.format,Y.colorSpace),ve=o.convert(Y.type),xe=E(Y.internalFormat,Le,ve,Y.colorSpace);if(!n.get(y).__hasExternalTextures){const de=Math.max(1,y.width>>ae),Ce=Math.max(1,y.height>>ae);oe===i.TEXTURE_3D||oe===i.TEXTURE_2D_ARRAY?t.texImage3D(oe,ae,xe,de,Ce,y.depth,0,Le,ve,null):t.texImage2D(oe,ae,xe,de,Ce,0,Le,ve,null)}t.bindFramebuffer(i.FRAMEBUFFER,w),nt(y)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ne,oe,n.get(Y).__webglTexture,0,De(y)):(oe===i.TEXTURE_2D||oe>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&oe<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,ne,oe,n.get(Y).__webglTexture,ae),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ue(w,y,Y){if(i.bindRenderbuffer(i.RENDERBUFFER,w),y.depthBuffer&&!y.stencilBuffer){let ne=i.DEPTH_COMPONENT24;if(Y||nt(y)){const oe=y.depthTexture;oe&&oe.isDepthTexture&&(oe.type===Pi?ne=i.DEPTH_COMPONENT32F:oe.type===go&&(ne=i.DEPTH_COMPONENT24));const ae=De(y);nt(y)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ae,ne,y.width,y.height):i.renderbufferStorageMultisample(i.RENDERBUFFER,ae,ne,y.width,y.height)}else i.renderbufferStorage(i.RENDERBUFFER,ne,y.width,y.height);i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.RENDERBUFFER,w)}else if(y.depthBuffer&&y.stencilBuffer){const ne=De(y);Y&&nt(y)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,ne,i.DEPTH24_STENCIL8,y.width,y.height):nt(y)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ne,i.DEPTH24_STENCIL8,y.width,y.height):i.renderbufferStorage(i.RENDERBUFFER,i.DEPTH_STENCIL,y.width,y.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.RENDERBUFFER,w)}else{const ne=y.textures;for(let oe=0;oe<ne.length;oe++){const ae=ne[oe],Le=o.convert(ae.format,ae.colorSpace),ve=o.convert(ae.type),xe=E(ae.internalFormat,Le,ve,ae.colorSpace),Ve=De(y);Y&&nt(y)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ve,xe,y.width,y.height):nt(y)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ve,xe,y.width,y.height):i.renderbufferStorage(i.RENDERBUFFER,xe,y.width,y.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Se(w,y){if(y&&y.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,w),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(y.depthTexture).__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),I(y.depthTexture,0);const ne=n.get(y.depthTexture).__webglTexture,oe=De(y);if(y.depthTexture.format===oo)nt(y)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ne,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ne,0);else if(y.depthTexture.format===$o)nt(y)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ne,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ne,0);else throw new Error("Unknown depthTexture format")}function ge(w){const y=n.get(w),Y=w.isWebGLCubeRenderTarget===!0;if(w.depthTexture&&!y.__autoAllocateDepthBuffer){if(Y)throw new Error("target.depthTexture not supported in Cube render targets");Se(y.__webglFramebuffer,w)}else if(Y){y.__webglDepthbuffer=[];for(let ne=0;ne<6;ne++)t.bindFramebuffer(i.FRAMEBUFFER,y.__webglFramebuffer[ne]),y.__webglDepthbuffer[ne]=i.createRenderbuffer(),ue(y.__webglDepthbuffer[ne],w,!1)}else t.bindFramebuffer(i.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer=i.createRenderbuffer(),ue(y.__webglDepthbuffer,w,!1);t.bindFramebuffer(i.FRAMEBUFFER,null)}function tt(w,y,Y){const ne=n.get(w);y!==void 0&&K(ne.__webglFramebuffer,w,w.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),Y!==void 0&&ge(w)}function $e(w){const y=w.texture,Y=n.get(w),ne=n.get(y);w.addEventListener("dispose",V);const oe=w.textures,ae=w.isWebGLCubeRenderTarget===!0,Le=oe.length>1;if(Le||(ne.__webglTexture===void 0&&(ne.__webglTexture=i.createTexture()),ne.__version=y.version,r.memory.textures++),ae){Y.__webglFramebuffer=[];for(let ve=0;ve<6;ve++)if(y.mipmaps&&y.mipmaps.length>0){Y.__webglFramebuffer[ve]=[];for(let xe=0;xe<y.mipmaps.length;xe++)Y.__webglFramebuffer[ve][xe]=i.createFramebuffer()}else Y.__webglFramebuffer[ve]=i.createFramebuffer()}else{if(y.mipmaps&&y.mipmaps.length>0){Y.__webglFramebuffer=[];for(let ve=0;ve<y.mipmaps.length;ve++)Y.__webglFramebuffer[ve]=i.createFramebuffer()}else Y.__webglFramebuffer=i.createFramebuffer();if(Le)for(let ve=0,xe=oe.length;ve<xe;ve++){const Ve=n.get(oe[ve]);Ve.__webglTexture===void 0&&(Ve.__webglTexture=i.createTexture(),r.memory.textures++)}if(w.samples>0&&nt(w)===!1){Y.__webglMultisampledFramebuffer=i.createFramebuffer(),Y.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,Y.__webglMultisampledFramebuffer);for(let ve=0;ve<oe.length;ve++){const xe=oe[ve];Y.__webglColorRenderbuffer[ve]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,Y.__webglColorRenderbuffer[ve]);const Ve=o.convert(xe.format,xe.colorSpace),de=o.convert(xe.type),Ce=E(xe.internalFormat,Ve,de,xe.colorSpace,w.isXRRenderTarget===!0),st=De(w);i.renderbufferStorageMultisample(i.RENDERBUFFER,st,Ce,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ve,i.RENDERBUFFER,Y.__webglColorRenderbuffer[ve])}i.bindRenderbuffer(i.RENDERBUFFER,null),w.depthBuffer&&(Y.__webglDepthRenderbuffer=i.createRenderbuffer(),ue(Y.__webglDepthRenderbuffer,w,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ae){t.bindTexture(i.TEXTURE_CUBE_MAP,ne.__webglTexture),ce(i.TEXTURE_CUBE_MAP,y);for(let ve=0;ve<6;ve++)if(y.mipmaps&&y.mipmaps.length>0)for(let xe=0;xe<y.mipmaps.length;xe++)K(Y.__webglFramebuffer[ve][xe],w,y,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ve,xe);else K(Y.__webglFramebuffer[ve],w,y,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ve,0);m(y)&&f(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Le){for(let ve=0,xe=oe.length;ve<xe;ve++){const Ve=oe[ve],de=n.get(Ve);t.bindTexture(i.TEXTURE_2D,de.__webglTexture),ce(i.TEXTURE_2D,Ve),K(Y.__webglFramebuffer,w,Ve,i.COLOR_ATTACHMENT0+ve,i.TEXTURE_2D,0),m(Ve)&&f(i.TEXTURE_2D)}t.unbindTexture()}else{let ve=i.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(ve=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ve,ne.__webglTexture),ce(ve,y),y.mipmaps&&y.mipmaps.length>0)for(let xe=0;xe<y.mipmaps.length;xe++)K(Y.__webglFramebuffer[xe],w,y,i.COLOR_ATTACHMENT0,ve,xe);else K(Y.__webglFramebuffer,w,y,i.COLOR_ATTACHMENT0,ve,0);m(y)&&f(ve),t.unbindTexture()}w.depthBuffer&&ge(w)}function z(w){const y=w.textures;for(let Y=0,ne=y.length;Y<ne;Y++){const oe=y[Y];if(m(oe)){const ae=w.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,Le=n.get(oe).__webglTexture;t.bindTexture(ae,Le),f(ae),t.unbindTexture()}}}const _t=[],Pe=[];function xt(w){if(w.samples>0){if(nt(w)===!1){const y=w.textures,Y=w.width,ne=w.height;let oe=i.COLOR_BUFFER_BIT;const ae=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Le=n.get(w),ve=y.length>1;if(ve)for(let xe=0;xe<y.length;xe++)t.bindFramebuffer(i.FRAMEBUFFER,Le.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Le.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Le.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Le.__webglFramebuffer);for(let xe=0;xe<y.length;xe++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(oe|=i.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(oe|=i.STENCIL_BUFFER_BIT)),ve){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Le.__webglColorRenderbuffer[xe]);const Ve=n.get(y[xe]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ve,0)}i.blitFramebuffer(0,0,Y,ne,0,0,Y,ne,oe,i.NEAREST),c===!0&&(_t.length=0,Pe.length=0,_t.push(i.COLOR_ATTACHMENT0+xe),w.depthBuffer&&w.resolveDepthBuffer===!1&&(_t.push(ae),Pe.push(ae),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Pe)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,_t))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ve)for(let xe=0;xe<y.length;xe++){t.bindFramebuffer(i.FRAMEBUFFER,Le.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.RENDERBUFFER,Le.__webglColorRenderbuffer[xe]);const Ve=n.get(y[xe]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Le.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.TEXTURE_2D,Ve,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Le.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&c){const y=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[y])}}}function De(w){return Math.min(s.maxSamples,w.samples)}function nt(w){const y=n.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function Ge(w){const y=r.render.frame;u.get(w)!==y&&(u.set(w,y),w.update())}function it(w,y){const Y=w.colorSpace,ne=w.format,oe=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||Y!==ci&&Y!==Ki&&(yt.getTransfer(Y)===bt?(ne!==gi||oe!==is)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",Y)),y}function Rt(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(l.width=w.naturalWidth||w.width,l.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(l.width=w.displayWidth,l.height=w.displayHeight):(l.width=w.width,l.height=w.height),l}this.allocateTextureUnit=X,this.resetTextureUnits=v,this.setTexture2D=I,this.setTexture2DArray=J,this.setTexture3D=ie,this.setTextureCube=re,this.rebindTextures=tt,this.setupRenderTarget=$e,this.updateRenderTargetMipmap=z,this.updateMultisampleRenderTarget=xt,this.setupDepthRenderbuffer=ge,this.setupFrameBufferTexture=K,this.useMultisampledRTT=nt}function Qy(i,e){function t(n,s=Ki){let o;const r=yt.getTransfer(s);if(n===is)return i.UNSIGNED_BYTE;if(n===ld)return i.UNSIGNED_SHORT_4_4_4_4;if(n===ud)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Ag)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Tg)return i.BYTE;if(n===Eg)return i.SHORT;if(n===ad)return i.UNSIGNED_SHORT;if(n===cd)return i.INT;if(n===go)return i.UNSIGNED_INT;if(n===Pi)return i.FLOAT;if(n===nr)return i.HALF_FLOAT;if(n===Ng)return i.ALPHA;if(n===bg)return i.RGB;if(n===gi)return i.RGBA;if(n===wg)return i.LUMINANCE;if(n===Rg)return i.LUMINANCE_ALPHA;if(n===oo)return i.DEPTH_COMPONENT;if(n===$o)return i.DEPTH_STENCIL;if(n===Cg)return i.RED;if(n===hd)return i.RED_INTEGER;if(n===Lg)return i.RG;if(n===dd)return i.RG_INTEGER;if(n===fd)return i.RGBA_INTEGER;if(n===Ua||n===Oa||n===Fa||n===Va)if(r===bt)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(n===Ua)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Oa)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Fa)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Va)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(n===Ua)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Oa)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Fa)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Va)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Jl||n===Ql||n===eu||n===tu)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(n===Jl)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ql)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===eu)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===tu)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===nu||n===iu||n===su)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(n===nu||n===iu)return r===bt?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(n===su)return r===bt?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===ou||n===ru||n===au||n===cu||n===lu||n===uu||n===hu||n===du||n===fu||n===pu||n===mu||n===gu||n===_u||n===xu)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(n===ou)return r===bt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ru)return r===bt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===au)return r===bt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===cu)return r===bt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===lu)return r===bt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===uu)return r===bt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===hu)return r===bt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===du)return r===bt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===fu)return r===bt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===pu)return r===bt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===mu)return r===bt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===gu)return r===bt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===_u)return r===bt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===xu)return r===bt?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===za||n===vu||n===yu)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(n===za)return r===bt?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===vu)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===yu)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Pg||n===Mu||n===Su||n===Tu)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(n===za)return o.COMPRESSED_RED_RGTC1_EXT;if(n===Mu)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Su)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Tu)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ir?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class eM extends Tn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Ur extends jt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const tM={type:"move"};class uc{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Ur,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Ur,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new L,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new L),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Ur,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new L,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new L),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,o=null,r=null;const a=this._targetRay,c=this._grip,l=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(l&&e.hand){r=!0;for(const x of e.hand.values()){const m=t.getJointPose(x,n),f=this._getHandJoint(l,x);m!==null&&(f.matrix.fromArray(m.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=m.radius),f.visible=m!==null}const u=l.joints["index-finger-tip"],h=l.joints["thumb-tip"],d=u.position.distanceTo(h.position),p=.02,g=.005;l.inputState.pinching&&d>p+g?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!l.inputState.pinching&&d<=p-g&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(o=t.getPose(e.gripSpace,n),o!==null&&(c.matrix.fromArray(o.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,o.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(o.linearVelocity)):c.hasLinearVelocity=!1,o.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(o.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&o!==null&&(s=o),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(tM)))}return a!==null&&(a.visible=s!==null),c!==null&&(c.visible=o!==null),l!==null&&(l.visible=r!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Ur;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const nM=`
void main() {
